if GetLocale() == "zhCN" then
	...
	Outfitter_cBossOutfit = "Boss怪物"
	Outfitter_cLvl63Outfit = "63级以上"
	Outfitter_cTrashOutfit = "普通怪物"
	Outfitter_cCritterOutfit = "小动物"

	Outfitter_cBeastTrashOutfit = "野兽普通怪"
	Outfitter_cUndeadTrashOutfit = "亡灵普通怪"
	Outfitter_cDemonTrashOutfit = "恶魔普通怪"
	...
	Outfitter_cItemAlreadyUsedError =
		"Outfitter: 无法将 %s 放在 %s 插槽中，因为它已经在另一个插槽中使用了。"
	...
	Outfitter_cConfirmUpdateMsg = "您确定要把装备 %s 更新到当前装备?"
	...
	Outfitter_cShowMinimapButtonOnDescription = "关闭它如果你不想在迷你地图上显示 Outfitter 按钮"
	Outfitter_cShowMinimapButtonOffDescription = "打开它如果你想在迷你地图上显示 Outfitter 按钮"
	Outfitter_cRememberVisibility = "记住披风和头盔的设置"
	Outfitter_cRememberVisibilityOnDescription =
		"关闭它如果你想对所有披风和头盔使用单一的显示/隐藏设置"
	Outfitter_cRememberVisibilityOffDescription =
		"打开它如果你想让 Outfitter 记住你对每件披风和头盔单独显示或隐藏的偏好"
	...
	Outfitter_cAuthor = ""
	Outfitter_cTestersTitle = "本插件已适配所有香草版本"
	Outfitter_cTestersNames = ""
	Outfitter_cSpecialThanksTitle = ""
	Outfitter_cSpecialThanksNames = ""
	Outfitter_cGuildURL = ""
	...
	Outfitter_cRidingOutfitDescription = "这套装备将在你骑乘时装备"
	...
	Outfitter_cBloodRingOutfitDescription = "这套装备将在你进鲜血之环战场时装备"
	Outfitter_cSunnygladeValleyOutfitDescription = "这套装备将在你进阳光林地山谷战场时装备"
	Outfitter_cCityOutfitDescription = "这套装备将在你进友方城镇时装备"
	Outfitter_cBossOutfitDescription = "这套装备将在你目标为63级以上的Boss怪物时自动装备"
	Outfitter_cLvl63OutfitDescription = "这套装备将在你目标为63级以上的怪物时自动装备"
	Outfitter_cTrashOutfitDescription = "这套装备将在你目标为63级以下的普通怪物时自动装备"
	Outfitter_cCritterOutfitDescription = "这套装备将在你目标为小动物时自动装备"
	Outfitter_cBeastTrashOutfitDescription =
		"这套装备将在你目标为63级以下的野兽普通怪物时自动装备"
	Outfitter_cUndeadTrashOutfitDescription =
		"这套装备将在你目标为63级以下的亡灵普通怪物时自动装备"
	Outfitter_cDemonTrashOutfitDescription =
		"这套装备将在你目标为63级以下的恶魔普通怪物时自动装备"
	...
	Outfitter_cDisableOutfitInInstance = "禁用装备在副本"
	...
	Outfitter_cPartialCategoryDescription =
		"部分混合匹配服装只有一些槽指定,但不是全部。在装备时，他们是在顶部你选择全套补充，更换任何其他部分混合匹配或配件的服装选择."
	Outfitter_cAccessoryCategoryDescription =
		"配件装备只有指定的插槽，但不是全部.  不像部分混合匹配,你可以选择你喜欢的衣服很多附件他们都会结合在一起，穿上你的选择的完整和部分混合匹配服装."
	Outfitter_cSpecialCategoryDescription = "特殊的场合的服装是自动穿每当场合的需要."
	Outfitter_cOddsNEndsCategoryDescription =
		"Odds 'n ends 是一个你没有用过的装备清单。  这可能是有用的，以确保您使用您的所有物品或您不携带超重行李。"
	...
	Outfitter_cSlotEnableDescription =
		"如果您想在选择该装备时，在该槽中的项目被装备，请选择此项。如果未选中，则在更改到所选装备时，该插槽不会被修改."
